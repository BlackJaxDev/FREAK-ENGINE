    ...
    public partial class XRMesh
    {
        public class BufferCollection : XRBase, IEventDictionary<string, XRDataBuffer>
        {
            ...
            public event EventDictionary<string, XRDataBuffer>.DelAdded? Added
            {
                add
                {
                    ((IReadOnlyEventDictionary<string, XRDataBuffer>)_buffers).Added += value;
                }
            ...
            public event EventDictionary<string, XRDataBuffer>.DelCleared? Cleared
            {
                add
                {
                    ((IReadOnlyEventDictionary<string, XRDataBuffer>)_buffers).Cleared += value;
                }
            ...
            public event EventDictionary<string, XRDataBuffer>.DelRemoved? Removed
            {
                add
                {
                    ((IReadOnlyEventDictionary<string, XRDataBuffer>)_buffers).Removed += value;
                }
            ...
            public event EventDictionary<string, XRDataBuffer>.DelSet? Set
            {
                add
                {
                    ((IReadOnlyEventDictionary<string, XRDataBuffer>)_buffers).Set += value;
                }
            ...
            public event Action? Changed
            {
                add
                {
                    ((IReadOnlyEventDictionary<string, XRDataBuffer>)_buffers).Changed += value;
                }
            ...
            {
                return ((IDictionary<string, XRDataBuffer>)_buffers).Remove(key);
            }
            ...
            public void Add(KeyValuePair<string, XRDataBuffer> item)
            {
                ((ICollection<KeyValuePair<string, XRDataBuffer>>)_buffers).Add(item);
            }
            ...
            {
                ((ICollection<KeyValuePair<string, XRDataBuffer>>)_buffers).CopyTo(array, arrayIndex);
            }

            public bool Remove(KeyValuePair<string, XRDataBuffer> item)
            {
                return ((ICollection<KeyValuePair<string, XRDataBuffer>>)_buffers).Remove(item);
            }

            public void Add(object key, object? value)
            {
                ((IDictionary)_buffers).Add(key, value);
            }
            ...
            {
                return ((IDictionary)_buffers).GetEnumerator();
            }

            public void Remove(object key)
            {
                ((IDictionary)_buffers).Remove(key);
            }

            public void CopyTo(Array array, int index)
            {
                ((ICollection)_buffers).CopyTo(array, index);
            }

            public void GetObjectData(SerializationInfo info, StreamingContext context)
            {
                ((ISerializable)_buffers).GetObjectData(info, context);
            }

            public void OnDeserialization(object? sender)
            {
                ((IDeserializationCallback)_buffers).OnDeserialization(sender);
            }

            IEnumerator<KeyValuePair<string, XRDataBuffer>> IEnumerable<KeyValuePair<string, XRDataBuffer>>.GetEnumerator()
            {
                return ((IEnumerable<KeyValuePair<string, XRDataBuffer>>)_buffers).GetEnumerator();
            }

            IEnumerator IEnumerable.GetEnumerator()
            {
                return ((IEnumerable)_buffers).GetEnumerator();
            }
